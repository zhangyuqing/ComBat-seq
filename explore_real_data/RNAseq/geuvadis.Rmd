...
subtitle: "GEUVADIS data used in SVA-seq"
author: Yuqing Zhang
date: "`r Sys.Date()`"
output:
  html_notebook:
...
The GEUVADIS consortium sequenced mRNAs and small RNAs of lymphoblastoid cell lines of 465 individuals in seven sequencing centers, with a large number of replicates[@ac2013reproducibility]. The variation between laboratories appeared to be considerably smaller than the already limited biological variation. The SVAseq paper [@leek2014svaseq] took the GEUVADIS data, subset the data to only the non-duplicated samples and performed a differential expression analysis comparing populations. 
...
I downloaded the data object directly from Github: https://github.com/leekgroup/ballgown_code (see "data" section in README).

```{r, echo=FALSE, results='hide'}
rm(list=ls())
output_dir <- "~/Google Drive/ComBat_seq/real_data_example/RNAseq/geuvadis"
sapply(c("DESeq2", "edgeR", "dendextend", "ggplot2", "reshape2", "gridExtra", "scales", "ggdendro"), 
       require, character.only=TRUE)


####  Load data
load(file.path(output_dir, "geuvadisbg.rda"))

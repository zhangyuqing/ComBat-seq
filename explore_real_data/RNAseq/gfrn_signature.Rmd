...
+ Biological fold change comparing average counts is about 1.3-1.4. 
+ Gene-wise fold change ranges from 1.7-1.8.
...
+ Mean batch effect fold change comparing average counts is quite large. 
...
+ Biological fold change (in non-zero portion) comparing average counts is about 1.3-1.4 (mean), 1.39 - 1.42 (median).**
...
+ Mean batch effect fold change comparing average counts is very large.

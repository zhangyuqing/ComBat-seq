...
png("Fullpipe_edgeR_FDR.png", width=10, height=6, units="in", res=300)
...
png("Fullpipe_DESeq2_FDR.png", width=10, height=6, units="in", res=300)
...
png("Fullpipe_edgeR_Sens.png", width=10, height=6, units="in", res=300)
...
png("Fullpipe_DESeq2_Sens.png", width=10, height=6, units="in", res=300)
...
png("Fullpipe_edgeR_scatter.png", width=10, height=6, units="in", res=300)
...
png("Fullpipe_DESeq2_scatter.png", width=10, height=6, units="in", res=300)

...
png("Fullpipe_edgeR_FDR_1example.png", width=6, height=4, units="in", res=300)
...
png("Fullpipe_DESeq2_FDR_1example.png", width=6, height=4, units="in", res=300)
...
png("Fullpipe_edgeR_Sens_1example.png", width=6, height=4, units="in", res=300)
...
png("Fullpipe_DESeq2_Sens_1example.png", width=6, height=4, units="in", res=300)
...
png("Fullpipe_edgeR_scatter_1example.png", width=6, height=4, units="in", res=300)
...
png("Fullpipe_DESeq2_scatter_1example.png", width=6, height=4, units="in", res=300)

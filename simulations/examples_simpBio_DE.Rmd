...
########  no dispersion effect, small mean batch effect
...
y2_ctrl <- matrix(rnbinom(50*5, mu=13, size=20), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
y2_case <- matrix(rnbinom(50*5, mu=26, size=20), ncol=5); #mean(c(y2_case)); var(c(y2_case))
y2_null <- matrix(rnbinom(950*10, mu=13, size=20), ncol=10)

y3_ctrl <- matrix(rnbinom(50*5, mu=13, size=20), ncol=5); #mean(c(y1_ctrl)); var(c(y1_ctrl))
y3_case <- matrix(rnbinom(50*5, mu=26, size=20), ncol=5); #mean(c(y1_case)); var(c(y1_case))
y3_null <- matrix(rnbinom(950*10, mu=13, size=20), ncol=10)

y4_ctrl <- matrix(rnbinom(50*5, mu=10, size=20), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
y4_case <- matrix(rnbinom(50*5, mu=20, size=20), ncol=5); #mean(c(y2_case)); var(c(y2_case))
y4_null <- matrix(rnbinom(950*10, mu=10, size=20), ncol=10)

#######  no mean batch effect but large dispersion effect
# y1_ctrl <- matrix(rnbinom(50*5, mu=10, size=20), ncol=5); #mean(c(y1_ctrl)); var(c(y1_ctrl))
# y1_case <- matrix(rnbinom(50*5, mu=20, size=20), ncol=5); #mean(c(y1_case)); var(c(y1_case))
# y1_null <- matrix(rnbinom(950*10, mu=10, size=20), ncol=10)
# 
# y2_ctrl <- matrix(rnbinom(50*5, mu=10, size=100), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
# y2_case <- matrix(rnbinom(50*5, mu=20, size=100), ncol=5); #mean(c(y2_case)); var(c(y2_case))
# y2_null <- matrix(rnbinom(950*10, mu=10, size=100), ncol=10)
# 
# y3_ctrl <- matrix(rnbinom(50*5, mu=10, size=100), ncol=5); #mean(c(y1_ctrl)); var(c(y1_ctrl))
# y3_case <- matrix(rnbinom(50*5, mu=20, size=100), ncol=5); #mean(c(y1_case)); var(c(y1_case))
# y3_null <- matrix(rnbinom(950*10, mu=10, size=100), ncol=10)
# 
# y4_ctrl <- matrix(rnbinom(50*5, mu=10, size=20), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
# y4_case <- matrix(rnbinom(50*5, mu=20, size=20), ncol=5); #mean(c(y2_case)); var(c(y2_case))
# y4_null <- matrix(rnbinom(950*10, mu=10, size=20), ncol=10)
...
# y1_null <- matrix(rnbinom(950*10, mu=10, size=20), ncol=10)
# 
# y2_ctrl <- matrix(rnbinom(50*5, mu=15, size=40), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
# y2_case <- matrix(rnbinom(50*5, mu=30, size=40), ncol=5); #mean(c(y2_case)); var(c(y2_case))
# y2_null <- matrix(rnbinom(950*10, mu=15, size=40), ncol=10)
# 
# y3_ctrl <- matrix(rnbinom(50*5, mu=15, size=40), ncol=5); #mean(c(y1_ctrl)); var(c(y1_ctrl))
# y3_case <- matrix(rnbinom(50*5, mu=30, size=40), ncol=5); #mean(c(y1_case)); var(c(y1_case))
# y3_null <- matrix(rnbinom(950*10, mu=15, size=40), ncol=10)
# 
# y4_ctrl <- matrix(rnbinom(50*5, mu=10, size=20), ncol=5); #mean(c(y2_ctrl)); var(c(y2_ctrl))
# y4_case <- matrix(rnbinom(50*5, mu=20, size=20), ncol=5); #mean(c(y2_case)); var(c(y2_case))
# y4_null <- matrix(rnbinom(950*10, mu=10, size=20), ncol=10)
...
```{r, echo=FALSE}
start_time <- Sys.time()
adj_counts <- ComBat_seq(counts=counts, batch=batch, group=group)#, gene.subset.n=100)  #, Cpp=TRUE)
end_time <- Sys.time()
...
de_called_base <- edgeR_DEpipe(counts_mat=counts_base, batch=batch, group=group, include.batch=FALSE, 
                               alpha.unadj=0.05, alpha.fdr=0.05)  
...
de_called <- edgeR_DEpipe(counts_mat=counts, batch=batch, group=group, include.batch=FALSE, 
                          alpha.unadj=0.05, alpha.fdr=0.05)  
...
de_called_onestep <- edgeR_DEpipe(counts_mat=counts, batch=batch, group=group, include.batch=TRUE, 
                                  alpha.unadj=0.05, alpha.fdr=0.05)  
...
de_called_adj <- edgeR_DEpipe(counts_mat=adj_counts, batch=batch, group=group, include.batch=FALSE, 
                              alpha.unadj=0.05, alpha.fdr=0.05)  
...
de_called_base <- DESeq2_DEpipe(counts_mat=counts_base, batch=batch, group=group, include.batch=FALSE, 
                                alpha.unadj=0.05, alpha.fdr=0.05)  
base_perf_stats <- perfStats(called_vec=de_called_base$unadj, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
base_perf_stats_fdr <- perfStats(called_vec=de_called_base$fdr, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))

de_called <- DESeq2_DEpipe(counts_mat=counts, batch=batch, group=group, include.batch=FALSE, 
                           alpha.unadj=0.05, alpha.fdr=0.05)  
perf_stats <- perfStats(called_vec=de_called$unadj, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
perf_stats_fdr <- perfStats(called_vec=de_called$fdr, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))

de_called_onestep <- DESeq2_DEpipe(counts_mat=counts, batch=batch, group=group, include.batch=TRUE, 
                                   alpha.unadj=0.05, alpha.fdr=0.05)  
onestep_perf_stats <- perfStats(called_vec=de_called_onestep$unadj, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
onestep_perf_stats_fdr <- perfStats(called_vec=de_called_onestep$fdr, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
  
de_called_adj <- DESeq2_DEpipe(counts_mat=adj_counts, batch=batch, group=group, include.batch=FALSE, 
                               alpha.unadj=0.05, alpha.fdr=0.05)  
adj_perf_stats <- perfStats(called_vec=de_called_adj$unadj, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
adj_perf_stats_fdr <- perfStats(called_vec=de_called_adj$fdr, ground_truth_vec=de_ground_truth, N_genes=nrow(counts))
```
...
plt_adj <- ggplot(pca_obj_adj$data, aes(x=PC1, y=PC2, color=Batch, shape=Group)) + 
  ...
  theme(legend.position="bottom")
print(grid.arrange(plt, plt_adj, ncol=2))
```

...
png("compFDR_edgeR_FDR_new.png", width=12, height=7, units="in", res=300)
...
png("compFDR_DESeq2_FDR_new.png", width=12, height=7, units="in", res=300)
...
png("compFDR_edgeR_Sens_new.png", width=10, height=8, units="in", res=300)
...
png("compFDR_DESeq2_Sens_new.png", width=10, height=8, units="in", res=300)
...
png("compFDR_edgeR_scatter_new.png", width=10, height=7, units="in", res=300)
...
png("compFDR_DESeq2_scatter_new.png", width=10, height=7, units="in", res=300)

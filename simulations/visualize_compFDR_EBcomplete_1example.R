...
png("EBcomplete_edgeR_FDR_1example.png", width=6, height=4, units="in", res=300)
...
fdr_lst_DESeq2$Method <- factor(fdr_lst_DESeq2$Method, levels=c("Base", "Batch", "OneStep", "ComBat.lm", "RUVseq", "SVAseq", 
                                                                "ComBatseq.ebON", "ComBatseq.ebOFF"))
fdr_lst_DESeq2$Method <- plyr::revalue(fdr_lst_DESeq2$Method, c("Base"="No Batch Effect"))
png("EBcomplete_DESeq2_FDR_1example.png", width=6, height=4, units="in", res=300)
...
png("EBcomplete_edgeR_Sens_1example.png", width=6, height=4, units="in", res=300)
...
png("EBcomplete_DESeq2_Sens_1example.png", width=6, height=4, units="in", res=300)
...
png("EBcomplete_edgeR_scatter_1example.png", width=6, height=4, units="in", res=300)
...
png("EBcomplete_DESeq2_scatter_1example.png", width=6, height=4, units="in", res=300)

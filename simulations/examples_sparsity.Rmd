...
subtitle: "add sparsity (0 counts) to simulate single-cell seq datasets"
author: Yuqing Zhang
...
The goal of this simulation is to see whether ComBat-seq can be used on counts with 0s.

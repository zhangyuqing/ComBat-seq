...
subtitle: "DE - turn off EB shrinkage"
author: Yuqing Zhang
date: March 21, 2019
...
results_dir <- "~/Documents/ComBat_seq/DE_analysis_shrinkOff"
```
...
for(i in 1:length(batch_fold_seq)){
  tpr_file <- sprintf("tpr_simFC_bio15_batch%s_sizes100_10_N20_B_depth5.csv", gsub('.', '', batch_fold_seq[i], fixed=TRUE))
  fpr_file <- sprintf("fpr_simFC_bio15_batch%s_sizes100_10_N20_B_depth5.csv", gsub('.', '', batch_fold_seq[i], fixed=TRUE))
...
for(i in 1:length(size1_seq)){
  tpr_file <- sprintf("tpr_simDisp_bio15_batch15_sizes%s_10_N20_B_depth5.csv", size1_seq[i])
  fpr_file <- sprintf("fpr_simDisp_bio15_batch15_sizes%s_10_N20_B_depth5.csv", size1_seq[i])
...
for(i in 1:length(design_seq)){
  tpr_file <- sprintf("tpr_simDesign_bio15_batch15_sizes100_10_N20_%s_depth5.csv", design_seq[i])
  fpr_file <- sprintf("fpr_simDesign_bio15_batch15_sizes100_10_N20_%s_depth5.csv", design_seq[i])
...
for(i in 1:length(depth_seq)){
  tpr_file <- sprintf("tpr_simDepth_bio15_batch15_sizes100_10_N20_B_depth%s.csv", depth_seq[i])
  fpr_file <- sprintf("fpr_simDepth_bio15_batch15_sizes100_10_N20_B_depth%s.csv", depth_seq[i])

...
if(demo){
  ...
  setwd("~/yuqingz/ComBat_seq/DE_disp_cnfnd_base_composition/")
  script_dir <- ".."
...
factor_exam <- ifelse(demo, "demo_comp", "DCbase_Comp")  #command_args[1]  
...
coverage <- 1 #as.numeric(command_args[8])  

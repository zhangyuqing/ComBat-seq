...
results_dir <- "./DE_libcomp_EBcomplete_outliers"
...
png("EBoutliers_edgeR_FDR.png", width=12, height=7, units="in", res=300)
...
png("EBoutliers_DESeq2_FDR.png", width=12, height=7, units="in", res=300)
...
png("EBoutliers_edgeR_Sens.png", width=10, height=8, units="in", res=300)
...
png("EBoutliers_DESeq2_Sens.png", width=10, height=8, units="in", res=300)
...
png("EBoutliers_edgeR_scatter.png", width=10, height=7, units="in", res=300)
...
png("EBoutliers_DESeq2_scatter.png", width=10, height=7, units="in", res=300)
